...
public record FornecedorDto(long Id, string TxRazaosocial, string TxNomefantasia, string TxCnpj, string TxTelefone, string TxEmail, string TxEndereco, string TxCidade, string TxEstado, bool FlIsenable);
public record FornecedorCreateDto(string TxRazaosocial, string TxNomefantasia, string TxCnpj, string TxTelefone, string TxEmail, string TxEndereco, string TxCidade, string TxEstado);
...
public record PedidoDeCompraDto(long Id, long ProdutoId, long FornecedorId, int NrQuantidade, string NrPrecounitario, decimal NrDescontounitario, decimal Subtotal, bool FlIsenable);
public record PedidoDeCompraCreateDto(long ProdutoId, long FornecedorId, int NrQuantidade, string NrPrecounitario, decimal NrDescontounitario, decimal Subtotal);
